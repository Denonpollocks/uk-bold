      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-end">
          ...
          <div className="lg:col-span-3 relative">
            ...
            <div className="relative">
              <input
                ...
                className="w-full h-14 px-4 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-0 text-lg font-medium placeholder-gray-400 transition-all duration-200 hover:border-gray-300"
                autoComplete="off"
              />
              {showOriginSuggestions && originSuggestions.length > 0 && (
                <div className="absolute z-50 w-full bg-white border border-gray-200 rounded-xl mt-2 shadow-2xl max-h-60 overflow-auto">
                  {originSuggestions.map((suggestion, idx) => (
                    <button
                      key={idx}
                      className="w-full px-4 py-3 text-left hover:bg-blue-50 transition-colors border-b border-gray-100 last:border-b-0 flex items-center"
          ...
          <div className="lg:col-span-1 flex justify-center">
            <button
              ...
              className="w-12 h-12 bg-blue-100 hover:bg-blue-200 rounded-full flex items-center justify-center transition-all duration-200 transform hover:scale-110 hover:rotate-180"
            >
          ...
          {/* Departure Date */}
          <div className="lg:col-span-2 relative" ref={departCalendarRef}>
            <label className="block text-sm font-semibold text-gray-700 mb-2">
              <svg className="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="w-full h-14 px-4 border-2 border-gray-200 rounded-xl focus:border-blue-500 text-left text-lg font-medium transition-all duration-200 hover:border-gray-300 flex items-center justify-between"
            >
          ...
          {searchData.tripType === "RT" && (
            <div className="lg:col-span-2 relative" ref={returnCalendarRef}>
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                <svg className="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
          ...
          {/* Passengers */}
          <div className={`${searchData.tripType === "RT" ? "lg:col-span-1" : "lg:col-span-2"} relative`} ref={passengersRef}>
            <label className="block text-sm font-semibold text-gray-700 mb-2">
              <svg className="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="w-full h-14 px-4 border-2 border-gray-200 rounded-xl focus:border-blue-500 text-left text-lg font-medium transition-all duration-200 hover:border-gray-300 flex items-center justify-between"
            >
              <span className="text-gray-700">{getPassengerText()}</span>
              <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
              </svg>
            </button>
            ...
            {showPassengersDropdown && (
              <div className="absolute z-50 mt-2 w-full bg-white border border-gray-200 rounded-xl shadow-2xl p-6">
                    ...
                    <div key={type.key} className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-3">
                        <button
                          ...
                          className="w-10 h-10 rounded-full border-2 border-gray-200 flex items-center justify-center hover:border-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                        >
                        ...
                        <button
                          ...
                          className="w-10 h-10 rounded-full border-2 border-gray-200 flex items-center justify-center hover:border-blue-500 transition-colors"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Class */}
          <div className={`${searchData.tripType === "RT" ? "lg:col-span-1" : "lg:col-span-1"} relative`} ref={classRef}>
            <label className="block text-sm font-semibold text-gray-700 mb-2">
              <svg className="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8">
          <button
            ...
            className="w-full h-16 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 disabled:from-gray-400 disabled:to-gray-500 text-white font-bold text-xl rounded-xl transition-all duration-200 transform hover:scale-[1.02] disabled:scale-100 disabled:cursor-not-allowed shadow-lg hover:shadow-xl flex items-center justify-center space-x-3"
          >
            {loading ? (
              <>
